pathProject <- "2022/2022-04-23-food-inflation-and-poverty"
...
fsvaRaw <- read_csv(here(pathProject, "data", "bkp-fsva-2021-raw.csv"))
...
foodExpPovertyClean |>
  write_csv(here(pathProject, "result", "food-expenditure-poverty-rate.csv"))
...
foodInflation |>
  write_csv(here(pathProject, "result", "inflation-food-overall-long.csv"))
...
argsCSVfoodInflation <- list(
  ...
  file = list(
    here(pathProject, "result", "inflation-food-overall-wide.csv"),
    here(pathProject, "result", "inflation-food-wide.csv"),
    here(pathProject, "result", "inflation-beverage-nonalcoholic-wide.csv"),
    here(pathProject, "result", "inflation-tobacco-wide.csv"),
    here(pathProject, "result", "inflation-beverage-alcoholic-wide.csv")
  )
)
